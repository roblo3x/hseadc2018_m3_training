...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { cart_id: @cart_item.cart_id, price: @cart_item.price, product_id: @cart_item.product_id, product_item_id: @cart_item.product_item_id } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { cart_id: @cart_item.cart_id, price: @cart_item.price, product_id: @cart_item.product_id, product_item_id: @cart_item.product_item_id } }
