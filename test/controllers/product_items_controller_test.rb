...
class ProductItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_item" do
    assert_difference('ProductItem.count') do
      post product_items_url, params: { product_item: { color_id: @product_item.color_id, product_id: @product_item.product_id, serial_number: @product_item.serial_number } }
    end
  ...
  test "should update product_item" do
    patch product_item_url(@product_item), params: { product_item: { color_id: @product_item.color_id, product_id: @product_item.product_id, serial_number: @product_item.serial_number } }
